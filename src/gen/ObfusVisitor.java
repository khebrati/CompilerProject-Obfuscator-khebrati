...
public interface ObfusVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code eitherDeclerationOrFunction}
	 * labeled alternative in {@link ObfusParser#statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitEitherDeclerationOrFunction(ObfusParser.EitherDeclerationOrFunctionContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link ObfusParser#declarationOrFunction}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
