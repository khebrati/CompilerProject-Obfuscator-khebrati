...
public interface ObfusListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code eitherDeclerationOrFunction}
	 * labeled alternative in {@link ObfusParser#statement}.
	 * @param ctx the parse tree
	 */
	void enterEitherDeclerationOrFunction(ObfusParser.EitherDeclerationOrFunctionContext ctx);
	/**
	 * Exit a parse tree produced by the {@code eitherDeclerationOrFunction}
	 * labeled alternative in {@link ObfusParser#statement}.
	 * @param ctx the parse tree
	 */
	void exitEitherDeclerationOrFunction(ObfusParser.EitherDeclerationOrFunctionContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link ObfusParser#declarationOrFunction}.
	 * @param ctx the parse tree
	 */
	void enterDeclarationOrFunction(ObfusParser.DeclarationOrFunctionContext ctx);
	/**
	 * Exit a parse tree produced by {@link ObfusParser#declarationOrFunction}.
	 * @param ctx the parse tree
	 */
